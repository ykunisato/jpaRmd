...
Yoshihiko Kunisato${}^\text{1}$・Yoshihiko. Senshu. Kunisato${}^\text{2}$

Department of Psychology, School of Human Sciences, Senshu University${}^\text{1}$,
Department of Psychology, School of Human Sciences, Sakigake Senshu University${}^\text{2}$

<!-- 
${}^\text{1}$は，上付き文字で数字をつけるための記法です。特に考える必要はなくて，｛｝内を変更ください。
-->
...
国里愛彦${}^\text{1}$・国里(専修)愛彦${}^\text{2}$

専修大学人間科学部心理学科${}^\text{1}$, 魁専修大学人間科学部心理学科${}^\text{2}$
